...
(function (global) {
  ...
  var controls = {
    ...
    create: function () {
      ...
      document
        .getElementById("select-local-file")
    ...
    play: function () {
      ...
      if (!video.paused) {
        // In case somehow hitting play button doesn't work.
    ...
    loadVideo: function (videoFile) {
      ...
      if (
        videoFile === "videos/Vidcon.webm" ||
        videoFile === "videos/Vidcon5.mp4"
      ) {
        manualRotation = [
          0.38175851106643677, -0.7102527618408203, -0.2401944249868393,
          0.5404701232910156,
        ];
      } else {
