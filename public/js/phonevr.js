...
PhoneVR.prototype.orientationIsAvailable = function () {
  // console.log("this.deviceAlpha", this.deviceAlpha);
  return this.deviceAlpha !== null;
};

PhoneVR.prototype.rotationQuat = function () {
  if (!this.orientationIsAvailable()) return quat.create(1, 0, 0, 0);
  ...
  var screenTransform = [
    0,
    0,
    -Math.sin(screenOrientation),
    Math.cos(screenOrientation),
  ];
